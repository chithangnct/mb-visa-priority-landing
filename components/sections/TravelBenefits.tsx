            ...
            <div className="container-custom relative z-10">
                ...
                >
                    ...
                    <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-white">
                        Ưu đãi <TextMorphInline className="text-gradient-silver" stagger={0.04}>du lịch</TextMorphInline>
                    </h2>
                </motion.div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="relative inline-flex">
                                    ...
                                    <div className="relative p-4 rounded-xl bg-gradient-to-br from-[#d0d0d0] via-[#f0f0f0] to-[#b8b8b8] shadow-lg group-hover:scale-110 transition-transform">

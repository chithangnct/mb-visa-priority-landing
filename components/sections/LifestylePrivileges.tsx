            ...
            <div className="container-custom relative z-10">
                ...
                >
                    ...
                    <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
                        <TextMorphInline className="text-white" stagger={0.04}>Ưu đãi </TextMorphInline><TextMorphInline className="text-gradient-silver" stagger={0.04} delay={0.3}>đẳng cấp</TextMorphInline>
                    </h2>
